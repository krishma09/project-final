...
<ul class="list">
<li><p><b>Using Ajax</b> − Make a server call to get the corresponding html page and set it in innerHTML of html control.</p></li>
<li><p><b>Using Server Side Includes</b> − JSP, PHP and other web side server technologies can include html pages within a dynamic page.</p></li>
</ul>
<p>Using AngularJS, we can embed HTML pages within a HTML page using ng-include directive.</p>
<pre class="prettyprint notranslate prettyprinted"><span class="tag">&lt;div</span><span class="pln"> </span><span class="atn">ng-app</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="atv">""</span><span class="pln"> </span><span class="atn">ng-controller</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="atv">"studentController"</span><span class="tag">&gt;</span><span class="pln">
   </span><span class="tag">&lt;div</span><span class="pln"> </span><span class="atn">ng-include</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="atv">"'main.htm'"</span><span class="tag">&gt;&lt;/div&gt;</span><span class="pln">
   </span><span class="tag">&lt;div</span><span class="pln"> </span><span class="atn">ng-include</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="atv">"'subjects.htm'"</span><span class="tag">&gt;&lt;/div&gt;</span><span class="pln">
</span><span class="tag">&lt;/div&gt;</span></pre>
<h4>Example</h4>
<p><i>tryAngularJS.htm</i></p>
<pre class="prettyprint notranslate tryit prettyprinted" title="main_htm, students_htm"><span class="tag">&lt;html&gt;</span><span class="pln">
      ...
      </span><span class="tag">&lt;div</span><span class="pln"> </span><span class="atn">ng-app</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="atv">"mainApp"</span><span class="pln"> </span><span class="atn">ng-controller</span><span class="pun">=</span><span class="atv">"studentController"</span><span class="tag">&gt;</span><span class="pln">
         </span><span class="tag">&lt;div</span><span class="pln"> </span><span class="atn">ng-include</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="atv">"'/angularjs/src/include/main.htm'"</span><span class="tag">&gt;&lt;/div&gt;</span><span class="pln">
         </span><span class="tag">&lt;div</span><span class="pln"> </span><span class="atn">ng-include</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="atv">"'/angularjs/src/include/subjects.htm'"</span><span class="tag">&gt;&lt;/div&gt;</span><span class="pln">
...
<p><i>main.htm</i></p>
<pre class="prettyprint notranslate prettyprinted" id="main_htm"><span class="tag">&lt;table</span><span class="pln"> </span><span class="atn">border</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="atv">"0"</span><span class="tag">&gt;</span><span class="pln">
...
<p><i>subjects.htm</i></p>
<pre class="prettyprint notranslate prettyprinted" id="students_htm"><span class="tag">&lt;p&gt;</span><span class="pln">Subjects:</span><span class="tag">&lt;/p&gt;</span><span class="pln">
...
<div class="row">
<a href="187_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="189_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
