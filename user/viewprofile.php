...
<strong style="font-size:20px;">    <h3 style="text-align:center;">User Profile</h3></strong>
<br>
...
<strong style="font-size:20px;">        
		...
		<div class="form-group ">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <label class=" control-label"><?php echo $u_name ;?></label>       </div>
          </div>
		            <div class="form-group">
            <label class="col-lg-3 control-label">City:</label>
            <div class="col-lg-8">
              <div class="ui-select">
				<label class=" control-label"><?php echo $u_city ;?></label>
			</div>
            </div>
          </div>
		  ...
		  <div class="form-group">
            ...
            <div class="col-lg-8">
			  ...
			  <label class=" control-label"><?php echo $u_gender ;?></label>
			  </div>
          </div>
		  </div>
         <br><br><br>
