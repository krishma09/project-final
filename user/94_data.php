...
<p>This chapter is going to cover important aspects of a <b>PL/SQL procedure</b>. We will discuss <b>PL/SQL function</b> in the next chapter.</p><h4>Parts of a PL/SQL Subprogram</h4>
...
<pre class="prettyprint notranslate prettyprinted"><span class="pln">CREATE </span><span class="pun">[</span><span class="pln">OR REPLACE</span><span class="pun">]</span><span class="pln"> PROCEDURE procedure_name 
...
<pre class="prettyprint notranslate prettyprinted"><span class="pln">CREATE OR REPLACE PROCEDURE greetings 
AS 
</span><span class="kwd">BEGIN</span><span class="pln"> 
...
<h4>Methods for Passing Parameters</h4>
...
<div class="row">
<a href="93_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="95_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
