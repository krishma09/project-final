...
$flag=1;	
	$obj=new conclass();
	$res1=$obj1->getdata("select * from que_tbl where flag='$flag' and fk_email_id='$email' LIMIT {$page1}, {$noi}");
...
//			$desc=$row["q_desc"];
	...
	//x		echo '<p class="question-desc" >'.$desc.'</p>';
		...
		$res1=$obj->getdata("select * from que_tbl where flag=1 and fk_email_id='$email'");
...
<?php
			...
			{	
			echo '<a href="myque.php?page='.$first_page.'" style="text-decoration:none;"><button class="button"><<</button></a>';	
			}
			if($prev_page==0)
			{
			...
			{
		echo '<a href="myque.php?page='.$prev_page.'" style="text-decoration:none;"><button class="button">Previous</button></a>';	
			}
			
			for($b=1;$b<=$a;$b++)
		{
			echo '<a href="myque.php?page='.$b.'" style="text-decoration:none;"><button class="button">'.$b.'</button></a>'; 
		}
		
		if($next_page==$a)
		{
			echo '<a href="myque.php?page='.$next_page.'" style="text-decoration:none;"><button class="button">Next</button></a>';	
		}
		else
		{	
		...
		{	
		echo '<a href="myque.php?page='.$last_page.'" style="text-decoration:none;"><button class="button">>></button></a>';
		}
		echo '</center>';
			}
		?>
