...
<pre class="prettyprint notranslate tryit" style="cursor: default;">&lt;html&gt;
   &lt;head&gt;
...
<pre class="prettyprint notranslate">File →  Print → Click OK  button.
</pre>
...
<div class="row">
<a href="73_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="75_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
