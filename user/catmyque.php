...
$cid=$_REQUEST["id"];
$obj1=new conclass();
$res1=$obj1->getdata("select count(a.pk_ans_id)'cnt',q.* from que_tbl as q ,ans_tbl as a where a.fk_q_id=q.pk_q_id and q.fk_cat_id=$cid and q.fk_email_id='$email' group by q.q_title");
