...
<ul class="list">
<li><p><b>Missing Semicolons</b> − Every PHP statement ends with a semicolon (;). PHP doesn't stop reading a statement until it reaches a semicolon. If you leave out the semicolon at the end of a line, PHP continues reading the statement on the following line.</p></li>
<li><p><b>Not Enough Equal Signs</b> − When you ask whether two values are equal in a comparison statement, you need two equal signs (==). Using one equal sign is a common mistake.</p></li>
<li><p><b>Misspelled Variable Names</b> − If you misspelled a variable then PHP understands it as a new variable. Remember: To PHP, $test is not the same variable as $Test.</p></li>
<li><p><b>Missing Dollar Signs</b> − A missing dollar sign in a variable name is really hard to see, but at least it usually results in an error message so that you know where to look for the problem.</p></li>
<li><p><b>Troubling Quotes</b> − You can have too many, too few, or the wrong kind of quotes. So check for a balanced number of quotes.</p></li>
<li><p><b>Missing Parentheses and curly brackets</b> − They should always be in pairs.</p></li>
<li><p><b>Array Index</b> − All the arrays should start from zero instead of 1.</p></li>
</ul>
...
<div class="row">
<a href="129_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="131_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
