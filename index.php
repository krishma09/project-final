...
<li  data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
<img src="images/green.jpg" alt="green" data-bgposition="center top" data-bgfit="normal" data-bgrepeat="repeat">
<div class="tp-caption customin stl cust-z-index-5 rs-cust-style8" data-x="20" data-y="230" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:0;skewX:0;skewY:0;opacity:0;" data-speed="1300" data-start="500"  >
<img src="images/slide-1-1.png" alt="">
</div>

<div class="tp-caption title sfr stl tp-resizeme cust-z-index-6 rs-cust-style1" data-x="770" data-y="170" data-speed="500" data-start="1350" >LogIn
</div>


<div class="tp-caption slide_text sfr stl tp-resizeme cust-z-index-7 rs-cust-style2" data-x="600" data-y="250" data-speed="500" data-start="1750" >
...
<div class="tp-caption text customin stl tp-resizeme cust-z-index-8 rs-cust-style3" data-x="700" data-y="460" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:-20;transformOrigin:50% 0%;" data-speed="500" data-start="2200" >
<div class="btn-group" >
  <button type="submit" style="font-size:18px;" name="btnlogin" class="slide_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_medium alignleft sc_buttons_st1 sc_buttons_st5">LogIn</button></a>
...
if (isset($_POST["btnlogin"]))
{
	...
	$obj=new conclass();
$res=$obj->getdata("select * from user_tbl where pk_email_id='$email' and u_pwd='$password'");
$row=mysql_fetch_array($res);
	...
	if($row["pk_email_id"]=="$email" && $row["u_pwd"]=="$password")
	{
...
<div class="tp-caption text customin stl tp-resizeme cust-z-index-8 rs-cust-style3" data-x="850" data-y="460" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:-20;transformOrigin:50% 0%;" data-speed="500" data-start="2200" >
<div class="btn-group" >
  <a href="signup.php"><button style="font-size:18px;" name="signup" class="slide_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_medium alignleft sc_buttons_st1 sc_buttons_st5">SignUp</button></a>
